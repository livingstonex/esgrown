...
export default class IndividualSignUp extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/check_email', individual)
            .then(res => {
                if (res.data.length > 0) {
                    ...
                    axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/add', individual)
                        .then(res => {
