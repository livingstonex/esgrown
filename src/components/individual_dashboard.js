        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://172.31.25.52:5000/servicecontenteas/notification`, lastLogin)
                .then(res => {
              ...
              //get eas exercises
              axios.post(`http://172.31.25.52:5000/excercise/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://172.31.25.52:5000/servicecontentefa/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://172.31.25.52:5000/servicecontentlm/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://172.31.25.52:5000/servicecontentrm/notification`, lastLogin)
                .then(res => {
