        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://13.59.192.18/api/servicecontenteas/notification`, lastLogin)
                .then(res => {
              ...
              //get eas exercises
              axios.post(`http://13.59.192.18/api/excercise/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://13.59.192.18/api/servicecontentefa/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://13.59.192.18/api/servicecontentlm/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://13.59.192.18/api/servicecontentrm/notification`, lastLogin)
                .then(res => {
