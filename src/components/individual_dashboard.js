        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://13.59.192.18/servicecontenteas/notification`, lastLogin)
                .then(res => {
              ...
              //get eas exercises
              axios.post(`http://13.59.192.18/excercise/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://13.59.192.18/servicecontentefa/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://13.59.192.18/servicecontentlm/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://13.59.192.18/servicecontentrm/notification`, lastLogin)
                .then(res => {
