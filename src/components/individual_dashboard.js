        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://localhost:5000/api/servicecontenteas/notification`, lastLogin)
                .then(res => {
              ...
              //get eas exercises
              axios.post(`http://localhost:5000/api/excercise/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://localhost:5000/api/servicecontentefa/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://localhost:5000/api/servicecontentlm/notification`, lastLogin)
                .then(res => {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://localhost:5000/api/servicecontentrm/notification`, lastLogin)
                .then(res => {
