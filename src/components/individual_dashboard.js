...
export default function MiniDrawer() {
  ...
  useEffect(() => {
    ...
    if (notify == 'loaded') {
        ...
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://172.31.25.5:5000/servicecontenteas/notification`, lastLogin)
                .then(res => {
              ...
              //get eas exercises
              axios.post(`http://172.31.25.5:5000/excercise/notification`, lastLogin)
                .then(res => {
      ...
      axios.get(`http://172.31.25.5:5000/subscriptionefa/${userData.id}`)
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://172.31.25.5:5000/servicecontentefa/notification`, lastLogin)
                .then(res => {
      ...
      //get lm subscription
      axios.get(`http://172.31.25.5:5000/subscriptionlm/${userData.id}`)
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://172.31.25.5:5000/servicecontentlm/notification`, lastLogin)
                .then(res => {
      ...
      //get rm subscription
      axios.get(`http://172.31.25.5:5000/subscriptionrm/${userData.id}`)
        .then(res => {
          ...
          if (res.data.length > 0) {
            if (res.data[0].sub_status) {
              ...
              axios.post(`http://172.31.25.5:5000/servicecontentrm/notification`, lastLogin)
                .then(res => {
