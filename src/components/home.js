...
export default class Home extends Component {
    ...
    onSubmit(e) {
        ...
        // axios.post('http://172.31.25.5:5000/individuals/login_email', User)
        //         .then(res => {
        ...
        //                 }
        //                 axios.post('http://172.31.25.5:5000/individuals/login', user_data)
        //                         .then(res => {
                                                ...
                                                <Form >
                                                    ...
                                                    <Button type="submit" className="btn_submit mb-2" onClick={
                                                        (e) => {
                                                            ...
                                                            // ==========================================
                                                            //Make a post to the api route for login
                                                            axios.post('http://172.31.25.5:5000/individuals/login', User)
                                                                .then(res => {
                                                                    if (res.data.length > 0) {
