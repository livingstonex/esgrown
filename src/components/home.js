...
export default class Home extends Component {
    ...
    onSubmit(e) {
        ...
        // axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/login_email', User)
        //         .then(res => {
        ...
        //                 }
        //                 axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/login', user_data)
        //                         .then(res => {
                                                ...
                                                <Form >
                                                    ...
                                                    <Button type="submit" className="btn_submit mb-2" onClick={
                                                        (e) => {
                                                            ...
                                                            // ==========================================
                                                            //Make a post to the api route for login
                                                            axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/login', User)
                                                                .then(res => {
                                                                    if (res.data.length > 0) {
