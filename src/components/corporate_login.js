                                    ...
                                    <Container style={formStyle}>
                                        ...
                                        <Form>
                                            ...
                                            <Button variant="primary" type="submit" onClick={(e) => {
                                                ...
                                                axios.post('http://13.59.192.18/api/corporates/login_corporate_email', Corporate_User)
                                                    .then(res => {
                                                        ...
                                                        if (res.data.length > 0) {
                                                            ...
                                                            axios.post('http://13.59.192.18/api/corporates/login_corporate', corp_user_data)
                                                                .then(res => {
