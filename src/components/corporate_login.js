                                    ...
                                    <Container style={formStyle}>
                                        ...
                                        <Form>
                                            ...
                                            <Button variant="primary" type="submit" onClick={(e) => {
                                                ...
                                                axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/corporates/login_corporate_email', Corporate_User)
                                                    .then(res => {
                                                        ...
                                                        if (res.data.length > 0) {
                                                            ...
                                                            axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/corporates/login_corporate', corp_user_data)
                                                                .then(res => {
