...
export default class Frontier extends Component {
    ...
    componentDidMount() {
        ...
        if (u.sub_status_eas === 'active') {
            axios.get(`http://13.59.192.18/subscriptioneas/getsubcode/${u.id}`)
                .then(subcode => {
                    if (subcode.data !== null) {
                        axios.get(`https://api.paystack.co/subscription/${subcode.data}`, { headers: { "Authorization": "Bearer sk_test_19f4c12e4e018a9f742e1723d42c9c8e509800b4" } })
                            .then(res => {
                                axios.post(`http://13.59.192.18/subscriptioneas/update/substatus/${u.id}`, { sub_status: res.data.data.status })
        ...
        if (u.sub_status_efa === 'active') {
            axios.get(`http://13.59.192.18/subscriptionefa/getsubcode/${u.id}`)
                .then(subcode => {
                    if (subcode.data !== null) {
                        axios.get(`https://api.paystack.co/subscription/${u.id}`, { headers: { "Authorization": "Bearer sk_test_19f4c12e4e018a9f742e1723d42c9c8e509800b4" } })
                            .then(res => {
                                ...
                                axios.post(`http://13.59.192.18/subscriptionefa/update/substatus/${u.id}`, { sub_status: res.data.data.status })
                                    .then(sub => console.log(sub.data)).catch(err => console.log(err))
                                let ls = JSON.parse(sessionStorage.getItem('key'));
        ...
        if (u.sub_status_rm === 'active') {
            ...
            axios.get(`http://13.59.192.18/subscriptionrm/getsubcode/${u.id}`)
                .then(subcode => {
                    if (subcode.data !== null) {
                        axios.get(`https://api.paystack.co/subscription/${subcode.data}`, { headers: { "Authorization": "Bearer sk_test_19f4c12e4e018a9f742e1723d42c9c8e509800b4" } })
                            .then(res => {
                                console.log(res.data.data.status);
                                axios.post(`http://13.59.192.18/subscriptionrm/update/substatus/${u.id}`, { sub_status: res.data.data.status })
                                    .then(sub => console.log(sub.data)).catch(err => console.log(err))
                                let ls = JSON.parse(sessionStorage.getItem('key'));
        ...
        if (u.sub_status_lm === 'active') {
            axios.get(`http://13.59.192.18/subscriptionlm/getsubcode/${u.id}`)
                .then(subcode => {
                    if (subcode.data !== null) {
                        axios.get(`https://api.paystack.co/subscription/${subcode.data}`, { headers: { "Authorization": "Bearer sk_test_19f4c12e4e018a9f742e1723d42c9c8e509800b4" } })
                            .then(res => {
                                console.log(res.data.data.status);
                                axios.post(`http://13.59.192.18/subscriptionlm/update/substatus/${u.id}`, { sub_status: res.data.data.status })
                                    .then(sub => console.log(sub.data)).catch(err => console.log(err))
                                let ls = JSON.parse(sessionStorage.getItem('key'));
        ...
        if (u.sub_status_compt_mgt === 'active') {
            axios.get(`http://13.59.192.18/competence/management/getuser/${u.id}`)
                .then(res => {
                    if (res.data !== null) {
                        ...
                        if (today > endDate) {
                            ...
                            axios.post(`http://13.59.192.18/competence/management/update/substatus/${u.id}`, { sub_status: 'completed' })
                                .then(sta => console.log(sta.data))
                                .catch(err => console.log(err));

                            //update the individuals' doc
                            axios.post(`http://13.59.192.18/individuals/update/substatus/${u.id}`, { sub_status_compt_mgt: 'completed' })
