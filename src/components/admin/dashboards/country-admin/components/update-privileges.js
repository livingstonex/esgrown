...
const UpdatePrivileges = () => {
    ...
    const updateUser = () => {
        ...
        axios.post(`http://18.188.101.36/admin/update/${userId}`, data)
            .then(res => {
                if (res.data) {

                    axios.post(`http://18.188.101.36/admin/admins/${user.country}`)
                        .then(res => {
                            if (res.data) {
                                setAdmins(res.data);
                            }
    ...
    const deleteCA = () => {
        ...
        axios.post(`http://18.188.101.36/admin/delete/${deleteUser._id}`)
            .then(res => {
                if (res.data) {
