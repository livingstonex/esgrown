...
const NewExercises = ({ service, refreshContentLog, title }) => {
    ...
    const exUrl = `http://localhost:5000/api/excercise/add`;
    ...
    const createQuestion = () => {
        ...
        axios.post(`http://localhost:5000/api/question/add`, questionData)
            .then(res => {
                ...
                axios.post(`http://localhost:5000/api/question/${res.data.excercise_id}`)
