...
const NewExercises = ({ service, refreshContentLog, title }) => {
    ...
    const exUrl = `http://13.59.192.18/api/excercise/add`;
    ...
    const createQuestion = () => {
        ...
        axios.post(`http://13.59.192.18/api/question/add`, questionData)
            .then(res => {
                ...
                axios.post(`http://13.59.192.18/api/question/${res.data.excercise_id}`)
