...
const NewExercises = ({ service, refreshContentLog, title }) => {
    ...
    const exUrl = `http://13.59.192.18/excercise/add`;
    ...
    const createQuestion = () => {
        ...
        axios.post(`http://13.59.192.18/question/add`, questionData)
            .then(res => {
                ...
                axios.post(`http://13.59.192.18/question/${res.data.excercise_id}`)
