...
const NewExercises = ({ service, refreshContentLog, title }) => {
    ...
    const exUrl = `http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/excercise/add`;
    ...
    const createQuestion = () => {
        ...
        axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/question/add`, questionData)
            .then(res => {
                ...
                axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/question/${res.data.excercise_id}`)
    ...
    function getAllJobs(corpid) {
        try {
            axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/jobs/${corpid}`)
                .then(jobs => {
