...
const NewExercises = ({ service, refreshContentLog, title }) => {
    ...
    const exUrl = `http://172.31.25.5:5000/excercise/add`;
    ...
    const createQuestion = () => {
        ...
        axios.post(`http://172.31.25.5:5000/question/add`, questionData)
            .then(res => {
                ...
                axios.post(`http://172.31.25.5:5000/question/${res.data.excercise_id}`)
