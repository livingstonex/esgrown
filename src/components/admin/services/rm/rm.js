...
const RM = () => {
    ...
    const newContentUrl = `http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/servicecontentrm/add`;



    useEffect(() => {

        axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/servicecontentrm/`)
            .then(res => {
