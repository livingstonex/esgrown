...
export default function Profile() {
  ...
  const handleSubmitEmail = (e) => {
    ...
    axios.post(`http://13.59.192.18/api/corporates/update/email/` + user_id, { email: email })
      .then((res) => {
  ...
  const handleSubmitPhone = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://13.59.192.18/api/corporates/update/phone/` + user_id, { phone: phone })
      .then((res) => {
  ...
  const handleSubmitCountry = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://13.59.192.18/api/corporates/update/country/` + user_id, { country: country })
      .then((res) => {
  ...
  const handleSubmitState = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://13.59.192.18/api/corporates/update/state/` + user_id, { state: state })
      .then((res) => {
