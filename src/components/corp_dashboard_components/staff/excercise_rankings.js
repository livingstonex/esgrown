...
export default function ExcerciseRankings({ page }) {
    ...
    function getJobs(id) {
        try {
            axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/jobs/${id}`)
                .then(res => {
    ...
    function getAnswers(jobId) {
        ...
        try {
            axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/answer/job/${jobId}`)
                .then(res => {
    ...
    //     try {
    //         setSpinner(true);
    //         axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/answer/${corpid}/${jobid}`)
    //                 .then(answers => { 
    //                     setSpinner(false);
