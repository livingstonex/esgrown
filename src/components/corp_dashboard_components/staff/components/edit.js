...
const EditStaff = ({ show, onHide, id, user, closeModal }) => {
    ...
    useEffect(() => {
        axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/`)
            .then(res => {
    ...
    const submitEdit = async () => {
        ...
        try {
            const res = await axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/staff/update/${edit._id}`, data);
            console.log(res.dat);
            closeModal()
