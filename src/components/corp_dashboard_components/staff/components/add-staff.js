            ...
            <Modal show={show} onHide={onHide} centered style={{marginTop:'50px'}}>
                ...
                <div className="container">
                    ...
                    <div className="row mt-3">
                        <div className="col">
                            <label style={{ fontWeight: 'bold' }}>{user && user.corp_type === "school" ? "teacher" : "staff"} Name</label>
                            <input type="text" name="title" value={jobsData.title} onChange={handleChange} placeholder="Name" className="form-control" required />
                        </div>
                    </div>
                    ...
                    <div className="row mt-3">
                        <div className="col">
                            ...
                            <input type="date" name="start_date" value="EAS" onChange={handleChange} placeholder="Exercise Title" className="form-control" required />
                        </div>
                    </div>
