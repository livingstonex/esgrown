...
const Staff = ({ ex_rankingpage }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/staff/${user.id}`)
            .then(res => {
        ...
        axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/rate/teacher/check/${user.org_name}`)
            .then(res => {
