...
const Subscription = () => {
    ...
    useEffect(() => {
        ...
        // axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/corporatesubscriptions/${company.id}`)
        //     .then(res => {
                    ...
                    <div className="col col-lg-4 col-sm-6">
                        ...
                        <Card className="">
                            <CardActionArea>
                                ...
                                />
                                <CardContent onClick={getRMDetails}>
                        ...
                        <Card className="">
                            <CardActionArea>
                                <CardMedia
                                    ...
                                    title="Contemplative Reptile"
                                />
                                <CardContent onClick={getLMdetails}>
                                    <Typography gutterBottom variant="" component="h5">
