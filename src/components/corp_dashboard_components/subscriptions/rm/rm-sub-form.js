...
const RMSubForm = ({ show, onHide, closeModal }) => {
    ...
    const subscribe = () => {
        ...
        // console.log(subData);
        axios.post(`http://172.31.25.52:5000/corporatesubscriptions/add`, subData)
            .then(res => {
                if (res.data) {
                    closeModal();
                    setPayModal(true);
    ...
    const onSuccess = async (response) => {
        ...
        axios.get(`https://api.paystack.co/subscription`, { headers: { "Authorization": "Bearer sk_test_19f4c12e4e018a9f742e1723d42c9c8e509800b4" } })
            .then(res => {
                ...
                axios.post(`http://172.31.25.52:5000/corporatesubscriptions/update/ref/${user.id}`, data)
                    .then(res => {
                ...
                axios.post(`http://172.31.25.52:5000/corporates/update/status/${user.id}`, data)
