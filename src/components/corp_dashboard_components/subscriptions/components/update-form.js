...
const UpdateCorp = ({ show, onHide, closeModal, service }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/corporatesubscriptions/${user.id}`)
            .then(res => {
    ...
    const update = () => {
        ...
        axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/corporatesubscriptions/update/email/${user.id}`, data)
            .then(res => {
                alert(res.data);
                setSpinner(false)
                closeModal()
    ...
    const onSuccess = (res) => {
        ...
        axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/corporatesubscriptions/update/ref/${userr.id}`, data)
