...
const UpdateCorp = ({ show, onHide, closeModal, service }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://18.188.101.36/corporatesubscriptions/${user.id}`)
            .then(res => {
    ...
    const update = () => {
        ...
        axios.post(`http://18.188.101.36/corporatesubscriptions/update/email/${user.id}`, data)
            .then(res => {
                alert(res.data);
                setSpinner(false)
                closeModal()
    ...
    const onSuccess = (res) => {
        ...
        axios.post(`http://18.188.101.36/corporatesubscriptions/update/ref/${userr.id}`, data)
