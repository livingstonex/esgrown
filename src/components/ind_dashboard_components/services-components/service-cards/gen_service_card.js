...
export default function GenServiceCard(){
    return(
        <React.Fragment>
            <div className="gen_card mb-5" style={{width:'100%', background:'#D0CFCF'}}>
                ...
                <div className="d-flex justify-content-center" style={{height:'7%'}}>
                    <p className="pt-3 pb-2" style={{fontFamily:'quicksand', fontSize:'14px', fontWeight:'bold', textAlign:'center'}}>IMPORTANCE OF THE HISTORY OF WESSEX</p>
                </div>
                <div className="d-flex justify-content-center mb-3 mt-3" style={{width:'100%', height:'43%', background:''}}>
