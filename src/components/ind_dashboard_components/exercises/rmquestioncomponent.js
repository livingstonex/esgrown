...
class QuestionsComponent extends Component {
    ...
    checkIfUserHasTakenEx(user, exid) {
        axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/answer/check`, {
            user_id: user,
            ex_id: exid
        }).then(res => {
    ...
    componentDidMount() {
        ...
        axios.get(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/question/${this.props.exercise._id}`)
            .then(res => {
