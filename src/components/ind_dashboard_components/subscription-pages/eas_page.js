...
export default function Profile() {
  ...
  const handleSubmitEmail = (e) => {
    ...
    axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/update/email/` + user_id, { email: email })
      .then((res) => {
  ...
  const handleSubmitGender = (e) => {
    ...
    axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/update/gender/' + user_id, { gender: gender })
      .then((res) => {
  ...
  const handleSubmitPhone = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/update/phone/` + user_id, { phone: phone })
      .then((res) => {
  ...
  const handleSubmitCountry = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/update/country/` + user_id, { country: country })
      .then((res) => {
  ...
  const handleSubmitState = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/individuals/update/state/` + user_id, { state: state })
      .then((res) => {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6" style={{}}>
              ...
              <Avatar style={{
                'height': '150px', 'width': '150px', 'backgroundColor': 'skyblue',
