...
export default function Profile() {
  ...
  const handleSubmitEmail = (e) => {
    ...
    axios.post(`http://localhost:5000/api/individuals/update/email/` + user_id, { email: email })
      .then((res) => {
  ...
  const handleSubmitGender = (e) => {
    ...
    axios.post('http://localhost:5000/api/individuals/update/gender/' + user_id, { gender: gender })
      .then((res) => {
  ...
  const handleSubmitPhone = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://localhost:5000/api/individuals/update/phone/` + user_id, { phone: phone })
      .then((res) => {
  ...
  const handleSubmitCountry = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://localhost:5000/api/individuals/update/country/` + user_id, { country: country })
      .then((res) => {
  ...
  const handleSubmitState = (e) => {
    ...
    const user_id = user.id;
    axios.post(`http://localhost:5000/api/individuals/update/state/` + user_id, { state: state })
      .then((res) => {
