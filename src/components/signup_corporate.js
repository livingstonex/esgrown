...
export default class IndividualSignUp extends Component {
    ...
    onSubmit(e) {
        ...
        if (this.state.confirmpassword === this.state.password) {
            ...
            axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/corporates/check_corp_email', corporate)
                .then(res => {
                    if (res.data.length > 0) {
                        ...
                        axios.post('http://ec2-18-188-101-36.us-east-2.compute.amazonaws.com:5000/corporates/add', corporate)
                            .then(res => {
